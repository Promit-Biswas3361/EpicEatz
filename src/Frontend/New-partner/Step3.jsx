        ...
        <div className="bg-white rounded-lg mb-8 py-6">
          <div className="border-b-1 border-gray-200 mb-3 pb-6 px-5">
            ...
            <p className="text-sm text-gray-400">
              Necessary legal and formal documents required for processing and validation.
            </p>
          </div>
          ...
          <div className="px-5">
            ...
            {/* Updated File Inputs */}
            <div className="mb-5">
              <label className="block mb-1 font-medium">Upload FSSAI Certificate*</label>
              <input
                type="file"
                name="fssai"
                required
                onChange={handleFileChange}
                className="w-full file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100"
              />
            </div>
            <div className="mb-5">
            ...
            <div className="mb-5">
              <label className="block mb-1 font-medium">Upload Shop Act License*</label>
              <input
                type="file"
                name="shopAct"
                required
            ...
            <div className="mb-5">
              <label className="block mb-1 font-medium">Upload Bank Proof*</label>
              <input
                type="file"
                name="bankProof"
                required
